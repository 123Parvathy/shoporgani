                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-price-block">
                      ...
                      <span class="aa-product-view-price"><del>Rs {{$product[0]->mrp}}</del></span>
                    ...
                    <div class="aa-prod-quantity">
                      ...
                      Product: <a href="#">{{$product[0]->name}}</a>
                      </p>
                      </div>
              ...
              @if(isset($related_product[0]))
                    ...
                    <li>
                        ...
                        <figcaption>
                            ...
                            <span class="aa-product-price">Rs {{$related_product[0]->price}}</span><span class="aa-product-price"><del>Rs {{$related_product[0]->mrp}}</del></span>
                        </figcaption>
                        </figure>                          
                    </li>  
                    @endforeach    
